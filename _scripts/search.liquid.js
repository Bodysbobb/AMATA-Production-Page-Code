...
/* Using settings from _config.yml */
{%- endcomment -%}

{%- assign excludeNavigation = site.search_settings.exclude_navigation | default: true -%}
{%- assign excludeDropdown = site.search_settings.exclude_dropdown | default: false -%}
{%- assign excludePosts = site.search_settings.exclude_posts | default: false -%}
{%- assign excludeBooks = site.search_settings.exclude_books | default: true -%}
{%- assign excludeTheme = site.search_settings.exclude_theme | default: true -%}
{%- assign excludeSocials = site.search_settings.exclude_socials | default: false -%}
